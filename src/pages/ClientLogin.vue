<template>
  <div class="min-h-screen flex items-center justify-center bg-[#0F111A] py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full bg-[#1A1C25] p-8 rounded-2xl shadow-xl space-y-6">
      <!-- Logo -->
      ...
      <!-- Error Alert -->
      <div v-if="error" class="bg-red-900/20 border border-red-500/50 p-4 rounded-lg">
        <div class="flex">
      ...
      <form class="space-y-6" @submit.prevent="handleLogin">
        ...
        <div>
          <button
            type="submit"
            :disabled="isLoading"
            class="w-full flex justify-center py-2 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-emerald-500 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
          >
        ...
        <div class="text-center">
          <p class="text-sm text-gray-400">
            ...
            <a href="#" class="font-medium text-emerald-400 hover:text-emerald-500">Sign up</a>
          </p>
        </div>
      </form>
    </div>
