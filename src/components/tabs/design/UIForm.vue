<!-- src/components/tabs/design/UIForm.vue -->
<template>
  <div>
    <div v-if="submitted">
      <h2 class="text-2xl font-bold mb-4">UI Design Submission Preview</h2>
      <div class="border p-4 rounded">
        <p><strong>Question 1:</strong> {{ formData.question1 }}</p>
        <p><strong>Question 2:</strong> {{ formData.question2 }}</p>
        <img :src="formData.image1" alt="Submitted UI Design" class="mt-4 w-full h-auto" />
      </div>
    </div>
...
const slides = [
  { title: 'Slide 1: Describe your UI needs' },
  { title: 'Slide 2: Upload your UI inspirations' },
];
